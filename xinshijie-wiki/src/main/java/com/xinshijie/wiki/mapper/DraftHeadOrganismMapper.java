...
public interface DraftHeadOrganismMapper extends BaseMapper<DraftHeadOrganism> {

    /**
    * 查询讨论主题表
    */
    List<DraftHeadOrganismVo> selectListDraftHeadOrganism(DraftHeadOrganismDto dto);

    /**
     * 普通方法
     * 分页查询讨论主题表
     */
    Page<DraftHeadOrganismVo> selectPageDraftHeadOrganism(Page<DraftHeadOrganismVo> page, @Param("dto") DraftHeadOrganismDto dto);

    /**
     * 分页查询讨论主题表
     * 基于 MyBatis-Plus 的写法，xml文件中的 ${ew.customSqlSegment} 会根据 Wrapper wrapper的传参自动生成wherer 条件。不推荐复杂where或者是多表联合查询
     */
    Page<DraftHeadOrganismVo> getPageDraftHeadOrganism(Page<DraftHeadOrganismVo> page, @Param(Constants.WRAPPER) Wrapper wrapper);
    ...
    DraftHeadOrganismVo selectByWidEid(@Param("wid") Integer wid, @Param("eid") Long eid, @Param("isDel") Integer isDel);
