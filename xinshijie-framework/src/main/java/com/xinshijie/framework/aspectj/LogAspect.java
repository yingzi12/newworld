...
import com.xinshijie.common.enums.BusinessStatus;
import com.xinshijie.common.enums.HttpMethod;
import com.xinshijie.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        ...
        try {
            ...
            if (!ServletUtils.getRequest().getRequestURI().startsWith("/wiki/")) {
                // 获取当前的用户
