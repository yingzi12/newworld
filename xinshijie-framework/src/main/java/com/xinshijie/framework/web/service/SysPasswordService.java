...
import com.xinshijie.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class SysPasswordService {
    ...
    public void validate(SysUser user) {
        ...
        Integer retryCount = redisCache.getCacheInteger(getCacheKey(username));
        ...
        if (!matches(user, password)) {
            ...
            redisCache.setCacheInteger(getCacheKey(username), retryCount, lockTime, TimeUnit.MINUTES);
