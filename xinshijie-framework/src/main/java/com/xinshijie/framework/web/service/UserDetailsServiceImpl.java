...
import com.xinshijie.common.enums.UserStatus;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails createLoginUser(SysUser user) {
        return new LoginUser(user.getUserId(), user.getDeptId(), user.getAvatar(), user, permissionService.getMenuPermission(user), user.getNickName(),user.getRanks());
    }
}
