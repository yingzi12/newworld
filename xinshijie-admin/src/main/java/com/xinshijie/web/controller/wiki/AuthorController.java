...
@Slf4j
@RestController
@Tag(name = "AuthorController", description = "作家")
@RequestMapping("/wiki/author")
public class AuthorController extends BaseController {
     ...
     */
    @GetMapping("/list")
    public TableDataInfo<List<AuthorVo>> list(AuthorFindDto dto) {
        startPage();
        List<AuthorVo> list = authorService.selectAuthorList(dto);
    ...
    @PostMapping("/add")
    public Result<String> add(@RequestBody AuthorDto redident) {
